  ...
  return (
    <div className="sec divide" id="why">
      <div className="wrap">
        ...
        <h2 className="serif [font-size:52px] text-center [max-width:760px] [margin:0_auto_12px]">
        ...
        <div className="crow">
          <div className="ccol">
            <div className="label clay [margin-bottom:8px]">Most tools</div>
            <h3 className="serif [font-size:26px] [margin-bottom:8px]">Store &amp; search.</h3>
        ...
        <p className="text-center [font-family:Newsreader] [font-size:26px] [line-height:1.4] [max-width:720px] [margin:52px_auto_0]">
